    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="${pageContext.request.contextPath}/Home">
                <img class="img" src="${pageContext.request.contextPath}/ressources/images/applogo.png" width="50" height="50" alt="logo">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
 				...
 				<form class="form-inline my-2 my-lg-0">
                    ...
                    <i class="fas fa-search search-bar-icon mx-2"></i>
                </form>
        ...
        <div class="cd-user-modal"> <!-- this is the entire modal form, including the background -->
            <div class="cd-user-modal-container"> <!-- this is the container wrapper -->
                ...
                <div id="cd-reset-password"> <!-- reset password form -->
                    <p class="cd-form-message">Mot de passe oubli�? Entrez votre adresse mail s'il vous plait. Vous allez recevoir un lien pour r�initialiser le mot de passe.</p>
