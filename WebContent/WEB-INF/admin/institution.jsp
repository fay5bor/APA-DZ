                ...
                <div class="card-header card-header-tabs card-header-primary">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                       <span class=""><b>Les institutions</b> </span>   
                  ...
                  <div class="tab-content">
                      <table class="table">
                          ...
                          <c:forEach items="${institutions}" var="institution">
                          	<tr>
                          		<td ><c:out value="${institution.id }"></c:out></td>
                          		<td><c:out value="${institution.nom }"></c:out></td>
                          		<td><c:out value="${institution.adresse }"></c:out></td>
                          		<td><c:out value="${institution.email }"></c:out></td>
                          		<td><c:out value="${institution.type }"></c:out></td>                                   		                          		                       		        		
                          	</tr>
                          </c:forEach>
                   	 	</tbody>                    
                      </table>
      	...
      	<div class="col-md-8 modal-content animate">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Ajouter une nouvelle institution</p>
                </div>
                <div class="card-body">
                  <form method="post" action="adminIns" encType="multipart/form-data">
                    <div class="row">                  
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select id="idSelectEtat" rel="tooltip" title="Privilège" name="type" class="form-control">
