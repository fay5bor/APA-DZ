...
public class testApi {
   ...
   */
  private static final String APPLICATION_NAME = "APA-DZ/Test0.1";

  private static final String UPLOAD_FILE_PATH = "APA-DZ_Test/Uploads/";
  private static final String DIR_FOR_DOWNLOADS = "APA-DZ_Test/Downloads/";
  ...
  public static void main(String[] args) {
    Preconditions.checkArgument(
        ...
        "Please enter the upload file path and download directory in %s", testApi.class);
