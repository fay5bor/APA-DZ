                ...
                <div class="card-header card-header-tabs card-header-primary">
                  <div class="nav-tabs-navigation">
                    <div class="nav-tabs-wrapper">
                       <span class=""><b>Les comptes administrateurs</b> </span>   
                  ...
                  <div class="tab-content">
                      <table class="table">
                      	<thead class="text-primary">
                   	 	...
                   	 	<tbody >                  	 		
                          <c:forEach items="${cmpAdmins}" var="cmpAdmin">
                          	<tr>
                          		<td class="idCpt"><c:out value="${cmpAdmin.id }"></c:out></td>
                          		<td><c:out value="${cmpAdmin.nom }"></c:out></td>
                          		<td><c:out value="${cmpAdmin.prenom }"></c:out></td>
                          		<td><c:out value="${cmpAdmin.email }"></c:out></td>
                          		<td class="text-primary">Niveau <c:out value="${cmpAdmin.privilege }"></c:out></td>                                   		
                          		<c:if test = "${cmpAdmin.active == 'true'}">
									<td>
                          			<button class="btn pull-right btn-danger btnAppliquerD" id="btnAppliquerD">Désactiver</button>
                          		    </td> 
  								</c:if>
								<c:if test = "${cmpAdmin.active == 'false'}">
									<td>
      	...
      	<div class="col-md-8 modal-content animate">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category">Créer un nouveau compte</p>
                </div>
                <div class="card-body">
                  <form method="post" action="adminCA"  encType="multipart/form-data">
                    <div class="row">                  
                      <div class="col-md-6">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="bmd-label-floating">Privilège</label>
                          <select id="idSelectEtat" rel="tooltip" title="Privilège" class="form-control" name="privilege">
                                <option value="A">Niveau A</option>
                               	<option value="B" selected>Niveau B</option>
                          </select> 
                        </div>
                      </div>                      
                    </div>                 
