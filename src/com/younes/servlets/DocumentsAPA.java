...
/**
 * Servlet implementation class DocumentsAPA
 */
@WebServlet("/DocumentsAPA")
public class DocumentsAPA extends HttpServlet {
...
//        	request.setAttribute( "link", link );
		...
		RequestDispatcher view=request.getRequestDispatcher("WEB-INF/views/DocumentsAPA.jsp");
